...
public final class Prueba4 {
	...
	public void testSelectores6(){
		...
		SelectorMision sm = new SelectorMisionRoverEnPeligro(cc.getRovers());
		Mision[] misionesEnPeligro = new Mision[] {m1, m2, m3};
		assertArrayEquals("SelectorMisionRoverEnPeligro", misionesEnPeligro, cc.getMisiones(sm));
	}	
	...
	public void testSelectores7(){
		...
		assertArrayEquals("BaseMarte.addMision con misiones a medias", misiones2, cc.getMisiones(new SelectorMisionTrue()));
...
/*			
    ...
    private static String runJUnit() {
		...
		try {
			...
			Request request = Request.aClass(Prueba4.class);
