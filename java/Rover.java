...
public class Rover {
 ...
 public static final long SAFETY_DISTANCE =2;
...
@Override
public int hashCode() {
	return Objects.hash(id, pos, power, t, vel);
}
@Override
public boolean equals(Object obj) {
	...
	return Objects.equals(id, other.id) && Objects.equals(pos, other.pos)
			&& Double.doubleToLongBits(power) == Double.doubleToLongBits(other.power) && t == other.t
